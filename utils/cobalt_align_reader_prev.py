...
class CobaltAlignReaderPrev(object):
    ...
    def read(self, alignment_file):
        ...
        for line in lines:
            if line.startswith('Sentence #'):
                ...
                indexes.append(CobaltAlignReaderPrev.read_alignment_idx(line))
                words.append(CobaltAlignReaderPrev.read_alignment_words(line))
                differences.append(CobaltAlignReaderPrev.read_differences(self, line))
